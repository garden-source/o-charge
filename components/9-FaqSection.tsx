...
const faqs = [
  ...
  },
  {
    ...
    answer: (
      <>
        おさいふチャージの母体は実績のある映像、コンテンツ制作会社（株式会社）です。<br />
        <br />
        個人撮影は撮影する方の「趣味」ですが、こちらは「プロ」の制作者達が対応致します。モデルさんの立場からすれば、個人の「欲」に対応するのか、プロの「仕事」に対応するのかという大きな違いがあると思います。<br />
        <br />
        また、個人撮影には報酬未払いや強要などのトラブルがつきものですので危険性も潜んでおりますが、法人運営なのでその様な心配もございません。
      </>
    ),
  },
];
